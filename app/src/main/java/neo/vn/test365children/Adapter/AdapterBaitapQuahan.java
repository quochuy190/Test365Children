...
public class AdapterBaitapQuahan extends RecyclerView.Adapter<AdapterBaitapQuahan.TopicViewHoder> {
    ...
    public AdapterBaitapQuahan(List<Baitap_Tuan> listAirport, Context context) {
