...
public class AdapterMenuUntility extends RecyclerView.Adapter<AdapterMenuUntility.TopicViewHoder> {
    ...
    public AdapterMenuUntility(List<ObjUntility> list, Context context) {
        this.list = list;
