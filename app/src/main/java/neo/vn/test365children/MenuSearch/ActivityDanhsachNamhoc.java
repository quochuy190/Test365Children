...
public class ActivityDanhsachNamhoc extends BaseActivity {
    ...
    private void initData() {
        mLisAirport.add("2018 - 2019");
        mLisAirport.add("2019 - 2020");
        mLisAirport.add("2020 - 2021");
        mLisAirport.add("2021 - 2022");
        mLisAirport.add("2022 - 2023");
        mLisAirport.add("2023 - 2024");
        mLisAirport.add("2024 - 2025");
