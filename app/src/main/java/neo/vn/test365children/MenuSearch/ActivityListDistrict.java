...
import neo.vn.test365children.Adapter.AdapterListDistrict;
...
public class ActivityListDistrict extends BaseActivity implements ImlMenuSearch.View, ImlMenuSearchRest.View {
    ...
    private void initData() {
        ...
        mPresenterRest.apirest_get_district(sUserId, sUserChild, sCityId);
    }
    ...
    public void show_get_list_district(ResponGetDistrict objRespon) {
        ...
        if (objRespon.getsERROR().equals("0000")) {
            if (objRespon.getLisDistrict() != null) {
                mLisAirport.addAll(objRespon.getLisDistrict());
                temp.addAll(mLisAirport);
                App.mLisDistrict.clear();
                App.mLisDistrict.addAll(mLisAirport);
                adapterService.notifyDataSetChanged();
